...
namespace osu.Framework.Audio.Track
{
    ...
    public class Waveform : IDisposable
    {
        ...
        /// <summary>
        /// FFT256 results in ~24ms per point @ 44.1kHz. This is the lowest resolution we can get from BASS.
        /// </summary>
        ...
        /// FFT256 results in a separation of ~170Hz per bin @ 44.1kHz.
        /// </summary>
        private const int fft_bins = 256;
        ...
        public Waveform(Stream data = null)
        {
            ...
            readTask = Task.Run(() =>
            {
                ...
                while (length > 0)
                {
                    ...
                    double lowIntensity = computeIntensity(info, bins, 0, 250);
                    double midIntensity = computeIntensity(info, bins, 250, 2000);
                    double highIntensity = computeIntensity(info, bins, 2000, 20000);
    ...
    public class WaveformPoint
    {
        ...
        /// <summary>
        /// Intensity of low-range (bass) frequencies.
        /// </summary>
        public double LowIntensity;

        /// <summary>
        /// Intesnity of mid-range frequencies.
        /// </summary>
        public double MidIntensity;

        /// <summary>
        /// Intensity of high-range (treble) frequencies.
        /// </summary>
