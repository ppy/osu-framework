...
namespace osu.Framework.Platform
{
    public abstract class OsuTKWindow : IWindow, IGameWindow
    {
        ...
        /// </summary>
        public OsuTKWindow([NotNull] IGameWindow implementation)
        {
        ...
        {
            get => Implementation.WindowState.ToFramework();
            set => Implementation.WindowState = value.ToOsuTK();
        }
