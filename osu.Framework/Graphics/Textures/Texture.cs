...
namespace osu.Framework.Graphics.Textures
{
    public class Texture : IDisposable
    {
        ...
        internal void DrawTriangle(Triangle vertexTriangle, ColourInfo drawColour, ref VertexBatchUsage<TexturedVertex2D> batch, RectangleF? textureRect = null,
                                   Vector2? inflationPercentage = null, RectangleF? textureCoords = null)
        {
            if (TextureGL == null || !TextureGL.Bind()) return;

            TextureGL.DrawTriangle(vertexTriangle, drawColour, ref batch, TextureBounds(textureRect), inflationPercentage, TextureBounds(textureCoords));
        }
        ...
        internal void DrawQuad(Quad vertexQuad, ColourInfo drawColour, ref VertexBatchUsage<TexturedVertex2D> batch, RectangleF? textureRect = null, Vector2? inflationPercentage = null,
                               Vector2? blendRangeOverride = null, RectangleF? textureCoords = null)
        {
            if (TextureGL == null || !TextureGL.Bind()) return;

            TextureGL.DrawQuad(vertexQuad, drawColour, ref batch, TextureBounds(textureRect), inflationPercentage, blendRangeOverride, TextureBounds(textureCoords));
        }
