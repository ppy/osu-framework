...
#pragma warning restore CS0612 // Type or member is obsolete
        ...
        public virtual IEnumerable<KeyBinding> PlatformKeyBindings => new[]
        {
            ...
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.KeycodeW), PlatformAction.DocumentClose),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.F4), PlatformAction.DocumentClose),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.KeycodeN), PlatformAction.DocumentNew),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.KeycodeT), PlatformAction.TabNew),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.Shift, InputKey.KeycodeT), PlatformAction.TabRestore),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.KeycodeS), PlatformAction.Save),
            new KeyBinding(InputKey.Home, PlatformAction.MoveToListStart),
            new KeyBinding(InputKey.End, PlatformAction.MoveToListEnd),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.KeycodeZ), PlatformAction.Undo),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.KeycodeY), PlatformAction.Redo),
            new KeyBinding(new KeyCombination(InputKey.Control, InputKey.Shift, InputKey.KeycodeZ), PlatformAction.Redo),
