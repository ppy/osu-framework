...
namespace osu.Framework.Graphics.Containers.Markdown
{
    public class MarkdownCodeStyle : KeyedCollection<string, MarkdownCodeStyle.Style>
    {
        ...
        protected virtual Color4 Blue => new Color4(0,0,255,255);
        protected virtual Color4 White => new Color4(255,255,255,255);
        protected virtual Color4 Black => new Color4(0,0,0,255);
        protected virtual Color4 DullRed => new Color4(163, 21, 21, 255);
        protected virtual Color4 Yellow => new Color4(255, 255, 0,255);
        protected virtual Color4 Green => new Color4(0, 128, 0,255);
        protected virtual Color4 PowderBlue => new Color4(176, 224, 230,255);
        protected virtual Color4 Teal => new Color4(0, 128, 12,255);
        protected virtual Color4 Gray => new Color4(128, 128, 128,255);
        protected virtual Color4 Navy => new Color4(0, 0, 128,255);
        protected virtual Color4 OrangeRed => new Color4(255, 69, 0,255);
        protected virtual Color4 Purple => new Color4(128, 0, 128,255);
        protected virtual Color4 Red => new Color4(255, 0, 0,255);
        protected virtual Color4 MediumTurqoise => new Color4(72, 209, 204,255);
        protected virtual Color4 Magenta => new Color4(255, 0, 255,255);
        protected virtual Color4 OliveDrab =>new Color4(107, 142, 35,255);
        protected virtual Color4 DarkOliveGreen => new Color4(85, 107, 47,255);
        protected virtual Color4 DarkCyan => new Color4(0, 139, 139,255);

        protected virtual Color4 DarkBackground => new Color4(30, 30, 30,255);
        protected virtual Color4 DarkPlainText => new Color4(218, 218, 218,255);

        protected virtual Color4 DarkXmlDelimeter => new Color4(128, 128, 128,255);
        protected virtual Color4 DarkXmlName => new Color4(230, 230, 230,255);
        protected virtual Color4 DarkXmlAttribute => new Color4(146, 202, 244,255);
        protected virtual Color4 DarkXamlCData => new Color4(192, 208, 136,255);
        protected virtual Color4 DarkXmlComment => new Color4(96, 139, 78,255);

        protected virtual Color4 DarkComment => new Color4(87, 166, 74,255);
        protected virtual Color4 DarkKeyword =>new Color4(86, 156, 214,255);
        protected virtual Color4 DarkGray => new Color4(155, 155, 155,255);
        protected virtual Color4 DarkNumber => new Color4(181, 206, 168,255);
        protected virtual Color4 DarkClass =>new Color4(78, 201, 176,255);
        protected virtual Color4 DarkString =>new Color4(214, 157, 133,255);
