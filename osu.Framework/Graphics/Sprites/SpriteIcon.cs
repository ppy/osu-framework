...
{
    /// <summary>
    /// A <see cref="SpriteIcon"/> backed by FontAwesome.
    /// </summary>
    public class SpriteIcon : SpriteIcon<FontAwesome>
    {
    }
        ...
        where T : struct, Enum
    {
        ...
        private void updateTexture()
        {
            ...
            var texture = store.Get(Convert.ToChar(loadableIcon).ToString());
