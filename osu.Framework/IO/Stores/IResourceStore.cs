...
namespace osu.Framework.IO.Stores
{
    ...
    internal static class ResourceStoreExtensions
    {
        ...
        public static IEnumerable<string> WhereNotIgnored(this IEnumerable<string> source) =>
            source.Where(entry => !filename_ignore_list.Any(ignoredName => entry.IndexOf(ignoredName, StringComparison.OrdinalIgnoreCase) >= 0));
    }
}
