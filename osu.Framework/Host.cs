...
namespace osu.Framework
{
    ...
    {
        public static DesktopGameHost GetSuitableHost(string gameName, bool bindIPC = false, bool portableInstallation = false, bool useOsuTK = false)
        {
            ...
            switch (RuntimeInfo.OS)
            {
                ...
                case RuntimeInfo.Platform.Linux:
                    return new LinuxGameHost(gameName, bindIPC, toolkitOptions, portableInstallation, useOsuTK);

                case RuntimeInfo.Platform.Windows:
                    return new WindowsGameHost(gameName, bindIPC, toolkitOptions, portableInstallation, useOsuTK);
