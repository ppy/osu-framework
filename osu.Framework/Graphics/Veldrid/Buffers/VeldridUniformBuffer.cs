...
namespace osu.Framework.Graphics.Veldrid.Buffers
{
        ...
        where TData : unmanaged, IEquatable<TData>
    {
        ...
        public TData Data
        {
            ...
            set
            {
                // Any vertices relying on the previous data must be flushed. The global UBO relies on this behaviour.
                // In most (user) cases, this is a no-op or would otherwise be caused by another operation (e.g. binding a custom shader/UBO).
