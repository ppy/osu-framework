...
namespace osu.Framework.Tests.Visual.UserInterface
{
    public class TestSceneFocusedOverlayContainer : TestScene
    {
        ...
        public ParentContainer ParentContainer { get; private set; }

        public void CreateOverlayContainer()
        {
            Child = OverlayContainer = new TestFocusedOverlayContainer();
        }

        public void CreateParentContainer()
        {
        ...
        public class TestFocusedOverlayContainer : FocusedOverlayContainer
        {
