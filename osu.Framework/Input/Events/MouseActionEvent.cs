...
{
    /// <summary>
    /// Represents events caused by a mouse button.
    /// </summary>
    public abstract class MouseActionEvent : MouseEvent
    {
        ...
        protected MouseActionEvent(InputState state, MouseButton button, Vector2? screenSpaceMouseDownPosition)
            : base(state)
        {
            Button = button;
