...
namespace osu.Framework.Graphics.UserInterface
{
    public class ExtendableButton : ClickableContainer
    {
        ...
        protected override bool OnHover(InputState state)
        {
            ...
            textContainer.MoveTo(Position + ExtendLenght, 150, Transformations.EasingTypes.OutElastic);
        ...
        protected override void OnHoverLost(InputState state)
        {
            ...
            textContainer.ClearTransformations();
            textContainer.MoveTo(Position + InitialExtendLenght, 150, Transformations.EasingTypes.OutElastic);
        }
