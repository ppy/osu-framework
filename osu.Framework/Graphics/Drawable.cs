...
namespace osu.Framework.Graphics
{
    ...
    public abstract partial class Drawable : Transformable, IDisposable, IDrawable
    {
        ...
        protected virtual IReadOnlyDependencyContainer CreateChildDependencies(IReadOnlyDependencyContainer parent) => DependencyActivator.BuildDependencies(this, parent);
