...
namespace osu.Framework.Graphics.Primitives
{
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        /// <summary>
        /// Gets a <see cref="RectangleF"/> with both <see cref="Width"/> and <see cref="Height"/> inflated in their corresponding directions.
        ...
        public RectangleF DirectionalInflate(MarginPadding amount) => new RectangleF(
            ...
            Width >= 0 ? Width + amount.TotalHorizontal : Width - amount.TotalHorizontal,
            Height >= 0 ? Height + amount.TotalVertical : Height - amount.TotalVertical
        );

        /// <summary>
        /// Gets a <see cref="RectangleF"/> with both <see cref="Width"/> and <see cref="Height"/> shrunk in their corresponding directions.
        /// The centre of the resultant <see cref="RectangleF"/> remains unchanged.
        /// </summary>
        /// <remarks>
