...
{
    /// <summary>
    /// The main game screen, where all screen
    /// elements are created, and key input from
    /// the player is used to drive current game state.
    /// </summary>
    public class GameScreen : DrawSizePreservingFillContainer
    {
        ...
        private void load(ISampleStore samples)
        {
            ...
            AddInternal(scoreSound = new DrawableSample(samples.Get("point.ogg")));
            AddInternal(punchSound = new DrawableSample(samples.Get("hit.ogg")));
            AddInternal(fallSound = new DrawableSample(samples.Get("die.ogg")));
            AddInternal(whooshSound = new DrawableSample(samples.Get("swoosh.ogg")));
