...
namespace osu.Framework.Platform.MacOS
{
    public class MacOSGameHost : DesktopGameHost
    {
        ...
        {
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeX), PlatformAction.Cut),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeC), PlatformAction.Copy),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeV), PlatformAction.Paste),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeA), PlatformAction.SelectAll),
            ...
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeW), PlatformAction.DocumentClose),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeN), PlatformAction.DocumentNew),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeT), PlatformAction.TabNew),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.Shift, InputKey.KeycodeT), PlatformAction.TabRestore),
            ...
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeS), PlatformAction.Save),
            ...
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.KeycodeZ), PlatformAction.Undo),
            new KeyBinding(new KeyCombination(InputKey.Super, InputKey.Shift, InputKey.KeycodeZ), PlatformAction.Redo),
