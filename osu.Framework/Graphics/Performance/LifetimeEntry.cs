...
{
    /// <summary>
    /// An object for a <see cref="LifetimeEntryManager"/> to consume, which provides a <see cref="LifetimeEntry{TDerived}.LifetimeStart"/> and <see cref="LifetimeEntry{TDerived}.LifetimeEnd"/>.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// The required base type for the <see cref="LifetimeEntryManager{T}"/> to consume, which provides a <see cref="LifetimeEntry{TDerived}.LifetimeStart"/> and <see cref="LifetimeEntry{TDerived}.LifetimeEnd"/>.
    /// </summary>
    ...
    public abstract class LifetimeEntry<TDerived> where TDerived : LifetimeEntry<TDerived>
    {
        ...
        /// <summary>
        /// The time at which this <see cref="LifetimeEntry{TDerived}"/> becomes alive in a <see cref="LifetimeEntryManager{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// The time at which this <see cref="LifetimeEntry{TDerived}"/> becomes dead in a <see cref="LifetimeEntryManager{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Update <see cref="LifetimeStart"/> of this <see cref="LifetimeEntry{TDerived}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Update <see cref="LifetimeEnd"/> of this <see cref="LifetimeEntry{TDerived}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Updates the stored lifetimes of this <see cref="LifetimeEntry{TDerived}"/>.
        /// </summary>
        ...
        /// <summary>
        /// The current state of this <see cref="LifetimeEntry{TDerived}"/>.
        /// </summary>
        internal LifetimeEntryState State { get; set; }

        /// <summary>
        /// Uniquely identifies this <see cref="LifetimeEntry{TDerived}"/> in a <see cref="LifetimeEntryManager{T}"/>.
        /// </summary>
