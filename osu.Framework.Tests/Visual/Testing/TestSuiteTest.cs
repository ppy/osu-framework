...
namespace osu.Framework.Tests.Visual.Testing
{
    public class TestSuiteTest : FrameworkTestSuite<EmptyTestScene>
    {
        ...
        protected override ITestSuiteTestRunner CreateRunner() => new TestRunner();

        private class TestRunner : TestSuiteTestRunner
        {
            public override void RunTestBlocking(TestSuite test)
            {
