...
namespace osu.Framework.Tests.Visual.UserInterface
{
    public class TestSceneDropdown : ManualInputManagerTestScene
    {
        ...
        public void TestDisabledCurrent()
        {
            ...
            AddStep("attempt to select first", () => disabledDropdown.Header.OnPressed(PlatformAction.MoveToListStart));
            valueIsUnchanged();

            AddStep("attempt to select last", () => disabledDropdown.Header.OnPressed(PlatformAction.MoveToListEnd));
            valueIsUnchanged();
