...
namespace osu.Framework.Platform.MacOS
{
    ...
    {
        internal MacOSGameHost(string gameName, bool allowMultipleInstances = true, bool bindIPC = false, ToolkitOptions toolkitOptions = default, bool portableInstallation = false)
