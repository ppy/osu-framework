...
namespace osu.Framework.Graphics.Sprites
{
    ...
    public class SpriteText : FillFlowContainer, IHasLineBaseHeight, IHasText, IHasFilterTerms
    {
        ...
        public override bool IsPresent => base.IsPresent && (!string.IsNullOrEmpty(displayText) || !layout.IsValid);
        ...
        private LocalisableString localisableText = new LocalisableString(string.Empty, LocalisationType.None);
        ...
        public string Text
        {
            ...
            get => displayText;
            [CanBeNull]
            set => LocalisableText = new LocalisableString(value ?? string.Empty, LocalisationType.Never);
        }
