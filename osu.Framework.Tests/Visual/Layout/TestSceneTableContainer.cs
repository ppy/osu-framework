...
namespace osu.Framework.Tests.Visual.Layout
{
    public class TestSceneTableContainer : FrameworkTestScene
    {
        ...
        public void TestOnlyContent()
        {
            ...
            AddAssert("headers not displayed", () => getGrid().Content._._.Length == 2);
        }
        ...
        public void TestContentAndHeaders()
        {
            ...
            AddAssert("4 rows", () => getGrid().Content._._.Length == 4);
            AddStep("disable headers", () => table.ShowHeaders = false);
            AddAssert("3 rows", () => getGrid().Content._._.Length == 3);
        }
        ...
        public void TestHeaderLongerThanContent()
        {
            ...
            AddAssert("3 columns", () => getGrid().Content._._.Max(r => r._.Length) == 3);
            AddStep("disable headers", () => table.ShowHeaders = false);
            AddAssert("2 columns", () => getGrid().Content._._.Max(r => r._.Length) == 2);
        }
        ...
        public void TestContentLongerThanHeader()
        {
            ...
            AddAssert("3 columns", () => getGrid().Content._._.Max(r => r._.Length) == 3);
            AddStep("disable headers", () => table.ShowHeaders = false);
            AddAssert("2 columns", () => getGrid().Content._._.Max(r => r._.Length) == 3);
        }
        ...
        public void TestColumnsWithAnchors()
        {
            ...
            {
                for (int r = 0; r < getGrid().Content._._.Length; r++)
                {
        ...
        public void TestRowSize()
        {
            ...
            {
                for (int row = 0; row < getGrid().Content._._.Length; row++)
                {
