...
namespace osu.Framework.Graphics
{
    public static class TransformableExtensions
    {
        ...
        /// <see cref="PopulateTransform{TValue, TThis}(TThis, Transform{TValue, TThis}, TValue, double, EasingTypes)"/>
        ...
        public static Transform<TValue, TThis> MakeTransform<TThis, TValue>(this TThis t, string propertyOrFieldName, TValue newValue, double duration, EasingTypes easing)
            where TThis : ITransformable =>
        ...
        public static Transform<TValue, TThis> PopulateTransform<TValue, TThis>(this TThis t, Transform<TValue, TThis> transform, TValue newValue, double duration, EasingTypes easing)
            where TThis : ITransformable
        {
            if (duration < 0)
        ...
        /// </summary>
        /// <returns>A <see cref="TransformSequence{T}"/> to which further transforms can be added.</returns>
        public static TransformSequence<T> FadeColour<T>(this T drawable, SRGBColour newColour, double duration = 0, EasingTypes easing = EasingTypes.None) where T : Drawable =>
        ...
        /// </summary>
        /// <returns>A <see cref="TransformSequence{T}"/> to which further transforms can be added.</returns>
        public static TransformSequence<T> FlashColour<T>(this T drawable, SRGBColour flashColour, double duration, EasingTypes easing = EasingTypes.None) where T : Drawable
        {
