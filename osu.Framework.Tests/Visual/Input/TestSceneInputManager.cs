...
namespace osu.Framework.Tests.Visual.Input
{
    public class TestSceneInputManager : FrameworkTestScene
    {
        ...
        {
            config.Set(FrameworkSetting.IgnoredInputHandlers, x ? $"{nameof(OsuTKMouseHandler)} {nameof(MouseHandler)}" : $"{nameof(OsuTKRawMouseHandler)} {nameof(SDL2RelativeMouseHandler)}");
        }
