...
{
    public class TestSuiteDelayedLoadWrapper : FrameworkTestSuite<EmptyTestScene>
    {
        ...
        public void TestManyChildren(bool instant)
        {
            ...
            TestSuiteDelayedLoadUnloadWrapper.TestScrollContainer scroll = null;
            int loaded = 0;
            ...
            AddStep("create children", () =>
            {
                ...
                {
                    scroll = new TestSuiteDelayedLoadUnloadWrapper.TestScrollContainer
                    {
