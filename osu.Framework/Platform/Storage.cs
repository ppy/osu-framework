...
namespace osu.Framework.Platform
{
    public abstract class Storage
    {
        ...
        /// <returns>A DateTime structure set to the creation date and time for the specified file. This value is expressed in local time.</returns>
        ...
        /// <returns>A DateTime structure set to the date and time that the specified file was last accessed. This value is expressed in local time.</returns>
