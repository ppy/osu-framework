...
namespace osu.Framework
{
    public abstract class Game : Container, IKeyBindingHandler<FrameworkAction>
    {
        ...
        private void load(FrameworkConfigManager config)
        {
            ...
            Textures = new TextureStore(new TextureUploadLoaderStore(new NamespacedResourceStore<byte[]>(Resources, @"Textures")));
            Textures.AddStore(new TextureUploadLoaderStore(new OnlineStore()));
