...
namespace osu.Framework.Audio.Track
{
    ...
    public class Waveform : IDisposable
    {
        ...
        /// <summary>
        /// FFT256 results in a separation of ~170Hz per bin @ 44.1kHz. This is the lowest resolution we can get from BASS.
        /// </summary>
        private const DataFlags fft_samples = DataFlags.FFT256;

        /// <summary>
        /// Number of bins generated by the FFT. Must correspond to <see cref="fft_samples"/>.
        /// </summary>
        private const int fft_bins = 128;
